# Iter9 (deepseek): Track-level 3-fold CV — 측정 체계 확보 + 증강 롤백
#
...
IMG_SIZE = 96            # 원본 중앙값 42px -> 96px가 상한. 128은 보간만 늘어남
NUM_CLASSES = 43
N_FOLDS = 3
...
LR_HEAD = 1e-3
SEED = 42
CLASS_WEIGHT_MODE = 'balanced'   # 'balanced'(iter6과 동일) | 'sqrt'(완화) | 'none'
